...
function type() {
  ...
  if (!isDeleting && charIndex < currentWord.length) {
    charIndex++;
    setTimeout(type, 120); // Velocidad de escritura (ligeramente más lenta para suavidad)
    ...
    setTimeout(type, 1200); // Pausa antes de cambiar palabra (redujimos de 1500ms a 1200ms)
  }
}
